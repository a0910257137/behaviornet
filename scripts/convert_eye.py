...
with open(
        '/aidata/anders/objects/landmarks/eye_wild/total/archive_model/max/INT8.tflite',
        'wb') as f:
    f.write(tflite_model)
# tf.lite.experimental.Analyzer.analyze(
#     model_path=
#     '/aidata/anders/objects/landmarks/eye_wild/total/archive_model/dp_glb/INT8.tflite',
