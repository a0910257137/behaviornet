...
class WarmUpCosineDecayScheduler(keras.callbacks.Callback):
    ...
    def __init__(self,
        ...
        self.steps_per_epoch = training_length
    ...
    def on_batch_begin(self, batch, logs=None):
        total_steps = int(self.total_epochs * self.steps_per_epoch)
        #self.params['epochs'] * self.params['samples'] / self.params['batch_size'])
        warmup_steps = int(self.warmup_epoch * self.steps_per_epoch)
    ...
    def cosine_decay_with_warmup(self,
                                 global_step,
                                 learning_rate_base,
                                 total_steps,
                                 warmup_learning_rate=0.0,
