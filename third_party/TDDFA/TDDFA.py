...
from .utils.tddfa_util import (load_model, _parse_param, similar_transform,
...
class TDDFA_ONNX(object):
    ...
    def __init__(self, cfg_dir, **kvs):
        # torch.set_grad_enabled(False)

        # load onnx version of BFM

        # bfm_fp = kvs.get('bfm_fp', os.path.join(cfg_dir, "bfm_noneck_v3.pkl"))
